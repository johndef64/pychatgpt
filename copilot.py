...
naive = "You are a coding copilot expert in any programming language."+reply_type['python']
...
robert = '''You are a scientific assistant, expert in python an R Bioinformatics. Your main fields are Biology and Informatics.'''+reply_type['r']
...
roger = delamain+'''\nYou are a scientific assistant, expert in python an R Bioinformatics. Your main fields are Biology and Informatics.'''+reply_type['r']
